...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(4, 30, init_scale=2e-4, name="fc2"),
            gelu(name='gelu'),
            fc(30, 7, init_scale=2e-4, name="fc3"),
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="tiny_flat"),
            fc(3072, 500, 2e-3, name="tiny_fc1"),
            gelu(name="tiny_gelu1"),
            fc(500, 20, 2e-3, name="tiny_fc2"),
            ########### END ###########
        )
